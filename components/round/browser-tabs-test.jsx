  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4">
      ...
      <div className="relative">
        ...
        {/* Main Chrome Window - Rounded Edges */}
        <div className="relative bg-[#DE6A48] border-2 border-black overflow-hidden rounded-xl">
          {/* Classic Chrome Title Bar */}
          <div className="bg-[#DE6A48] border-b-2 border-black p-2 rounded-t-xl">
          ...
          <div className="bg-[#F7F4E9] p-8 rounded-b-xl">
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                ...
                {currentTab?.subtitle && (
                  <div className="relative">
                    ...
                    {/* Sharp Badge */}
                    <span className="relative inline-block px-4 py-2 text-sm font-bold bg-[#DE6A48] border-2 border-black font-space-grotesk text-white rounded-lg">
                      {currentTab.subtitle}
                    </span>
                  </div>
                )}
              ...
              <div className="relative">
                <div className="absolute inset-0 bg-black translate-x-1 translate-y-1 rounded-lg"></div>
                <blockquote className="relative text-lg leading-relaxed text-black font-space-grotesk italic border-2 border-black bg-white p-6 rounded-lg">
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-black translate-x-1 translate-y-1 rounded-lg"></div>
                {/* Main Card */}
                <div className="relative bg-white border-2 border-black p-6 rounded-lg">
                  <div className="flex items-center gap-6">
                    ...
                    <div className="relative">
                      ...
                      <div className="relative w-16 h-16 bg-[#00796B] border-2 border-black flex items-center justify-center rounded-full">
              ...
              <div className="flex gap-4">
                <div className="relative">
                  ...
                  <div className="absolute inset-0 bg-black translate-x-1 translate-y-1 rounded-lg"></div>
                  {/* Main Button */}
                  <button className="relative px-6 py-3 bg-[#DE6A48] border-2 border-black text-white font-bold font-oswald hover:translate-x-0.5 hover:translate-y-0.5 transition-transform rounded-lg">
                    VIEW PROJECT
                  </button>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-0 bg-black translate-x-1 translate-y-1 rounded-lg"></div>
                  {/* Main Button */}
                  <button className="relative px-6 py-3 bg-white border-2 border-black text-black font-bold font-oswald hover:translate-x-0.5 hover:translate-y-0.5 transition-transform rounded-lg">
                    CONTACT US
                  </button>
                </div>
              </div>
